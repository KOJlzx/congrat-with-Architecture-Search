...
# python  bin/trainer.py fit -c "configs/gnn-pretrain/pubmed/base-lr-1e-2-20epoch.yaml";  
# python bin/trainer.py fit -c "configs/clip-graph/inductive-causal/pubmed/base.yaml"
